...
\begin{titlepage}
	...
	\begin{center}
		\textsf{\huge A Very Long Ph.D Thesis\\
		With a Long Title}
	\end{center}
	\begin{center}
		\textsf{by}
...
\textsf{\small
	...
	\parbox{\textwidth}{
		\fontsize{9}{10pt}
		\selectfont
		Joseph Thomas Bloggs. A Very Long Ph.D Thesis With a Long Title. Philosophiae Doctor thesis, University of Pretoria, Department of Computer Science, Pretoria, South Africa, April 2019.
	}\\*[10.5mm]
...
\begin{center}
	{\large\bf A Very Long Ph.D Dissertation With a Long Title}
\end{center}
